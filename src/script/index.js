const RENDER = {
    ...
    fillTab(data) {
        ...
        const contentWeek = document.getElementById('weather-week-content');

        tabToday.addEventListener('click', event => {
            ...
            contentWeek.setAttribute('hidden', true);
        });

        tabWeek.addEventListener('click', event => {
            event.preventDefault();
            tabWeek.classList.add('active');
            tabToday.classList.remove('active');

            contentWeek.removeAttribute('hidden');
            contentWeek.innerHTML = this.renderWeekDate(data);
            contentToday.setAttribute('hidden', true);
        });
